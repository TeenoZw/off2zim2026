    ...
    <div className="theme-page min-h-screen">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#8dc9ff]/25 bg-[#8dc9ff]/8 px-4 py-2 text-sm font-medium text-[#8dc9ff]">
              <ShoppingCart className="h-3.5 w-3.5" />
              Marketplace
            </div>
            <h1 className="theme-heading mt-4 text-4xl font-semibold">Shop Zimbabwe</h1>
...
function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="theme-panel group overflow-hidden rounded-[24px] transition hover:shadow-lg"
    >
      {/* Image */}
