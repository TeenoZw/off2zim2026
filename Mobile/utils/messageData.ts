...
const generateDynamicMessages = (): MessageData[] => {
  ...
  return [
    ...
    },
    {
      id: '2',
      name: 'The Boma',
      message: `Your dinner reservation for 4 people on ${new Date(now.getTime() + 2 * 24 * 60 * 60 * 1000).toLocaleDateString()} has been confirmed. We look forward to providing you with an authentic African dining experience.`,
      time: yesterday,
