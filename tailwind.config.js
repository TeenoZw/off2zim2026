  ...
  theme: {
    extend: {
      colors: {
        ...
        // Off2Zim Brand colors inspired by project folder theme
        off2zim: {
          primary: "#C95E27", // Terracotta
          secondary: "#2A9D8F", // Teal
          accent: "#F4A261", // Sandy orange
          success: "#538D22", // Green
          warning: "#FCBF49", // Amber
          error: "#E63946", // Red
        ...
        // Brand colors from existing design (keeping original ones)
        "primary-brand": {
          DEFAULT: "#000000",
          50: "#f6f6f6",
          100: "#e7e7e7",
        ...
        // Temperature colors for weather display
        temperature: {
          hot: "#ef4444",
          warm: "#f59e0b",
          cold: "#3b82f6",
